...
parser = argparse.ArgumentParser(
    prog='gtf2bed12.py', 
    description='Convert GTF file into BED12 file.', 
...
bed = ''
features2keep = ['gene', 'mRNA', 'exon', 'CDS']
...
for line in gtf_file:
    ...
    res=re.search('ID=([^;]+);', fields[8])
    id=res.group(1)

    if feature == 'exon' or feature == 'CDS':
        res=re.search('Parent=([^;]+);', fields[8])
        parent=res.group(1)
